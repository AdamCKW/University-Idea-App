...
export default function AddClosure({
    closure,
    showEditClosure,
    setShowEditClosure,
}) {
    const { _id, startDate, initialClosureDate, finalClosureDate } = closure;
    ...
    const formik = useFormik({
        initialValues: {
            ...
            initialClosureDate: formatDate(initialClosureDate) || '',
            finalClosureDate: formatDate(finalClosureDate) || '',
        },
    ...
    async function onSubmit(values) {
        ...
        try {
            await axios.put(`api/closure/${_id}`, values, options);
    ...
    return (
        <>
            <Dialog open={showEditClosure} onClose={handleClose}>
                <DialogTitle>Update Closure</DialogTitle>
