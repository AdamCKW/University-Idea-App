export default function TermsText() {
    return (
        <>
            <p>Welcome to University Idea App!</p>

            <p>
                These terms and conditions outline the rules and regulations for
                the use of University's Website, located at Website-URL.
            </p>

            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use University Idea App if you do
            ...
            <p>
                We employ the use of cookies. By accessing University Idea App,
                you agreed to use cookies in agreement with the University's
                Privacy Policy.
            </p>
            ...
            <p>
                Unless otherwise stated, University and/or its licensors own the
                intellectual property rights for all material on University Idea
                App. All intellectual property rights are reserved. You may
                access this from University Idea App for your own personal use
                subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from University Idea App</li>
                <li>
                    Sell, rent or sub-license material from University Idea App
                </li>
                <li>
                    Reproduce, duplicate or copy material from University Idea
                    App
                </li>
                <li>Redistribute content from University Idea App</li>
            </ul>
            ...
            <p>
                ...
                website. University does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of University,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, University shall not be liable for
            ...
            <p>
                University reserves the right to monitor all Comments and to
            ...
            <p>
                You hereby grant University a non-exclusive license to use,
            ...
            <p>
                ...
                of University; and (d) the link is in the context of general
            ...
            <p>
                ...
                by sending an e-mail to University. Please include your name,
            ...
            <p>
                No use of University's logo or other artwork will be allowed for
